...
public class ControlObjetosCuentas 
{
    ...
    //Procedimiento que permite bloquear los objetos en el formulario
    public void bloquearobjetoseliminar(
            JButton boton1,
            JButton boton2,
            JComboBox combo1,
            JTextField texto1,
    ...
    //Procedimiento que permite desbloquear los objetos en el formulario
    public void desbloquearobjetoseliminar(
            JButton boton1,
            JButton boton2,
            JComboBox combo1,
            JTextField texto1,
    ...
    //Procedimiento que permite limpiar los campos textos de cada formulario
    public void limpiarcampostextoseliminar(
            JTextField texto1,
            JTextField texto2,
            JTextField texto3,
            JTextField texto4,
    ...
    */
    public void cargarcombocuenta(JComboBox combo){
        combo.addItem("Corriente");
        combo.addItem("Ahorro");
    }
    public void cargarcombomoneda(JComboBox combo){
        combo.addItem("Dólares");
        combo.addItem("Colones");
    }
    public void cargarcombocondicioncuenta(JComboBox combo){
        combo.addItem("Activa");
        combo.addItem("Desactiva");
    }
}